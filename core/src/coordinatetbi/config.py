...
class Settings(BaseSettings):
    ...
    def effective_database_url(self) -> str:
        ...
        if self.environment == "test":
            return "postgresql+psycopg://postgres:postgres@postgres:5432/coordinatetbi_test"

        return "postgresql+psycopg://postgres:postgres@postgres:5432/coordinatetbi"
